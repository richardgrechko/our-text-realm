! function(e) {
	...
	function(e) {
		...
		k["addEventListener"]("pointerdown", (function(e) {
			...
			var e = n;
			hn["classList"]["contains"]("open") ? hn["classList"].remove("open") : (hn["classList"]["add"]("open"), gn())
...
function validRGB(r,g,b) {
			...
			switch (Object["keys"](a)[0]) {
				...
				case "msg":
					...
					! function(e, n, r, a) {
						...
						i.appendChild(c), u && gn(), hn["classList"]["contains"]("open")
					}(T[0], T[1], T[2], T[3]);
					break;
				case "rc":
		...
		function On() {
			var e = n;
			Ue = Pe["size"], Ke["innerText"] = Ue, document.getElementById("chatmsg")["placeholder"] = 0 == Ue ? "no one can hear you..." : 1 == Ue ? "chat to 1 other user" : "chat to " + Ue + " other users", y || En()
		}
